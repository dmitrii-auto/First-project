...
public class DeadlockFree {
    public static final File firstFile = new File(Objects.requireNonNull(DeadlockFree.class.getClassLoader().getResource("1.txt")).getFile());
    public static final File secondFile = new File(Objects.requireNonNull(DeadlockFree.class.getClassLoader().getResource("2.txt")).getFile());
